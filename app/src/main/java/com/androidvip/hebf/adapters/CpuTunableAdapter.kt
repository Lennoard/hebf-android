...
class CpuTunableAdapter(
    private val activity: Activity,
    private val mDataSet: ArrayList<CpuManager.GovernorTunable>?
) : RecyclerView.Adapter<CpuTunableAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(activity).inflate(
            R.layout.list_item_generic_param_large, parent, false
        )
        return ViewHolder(v)
    }
