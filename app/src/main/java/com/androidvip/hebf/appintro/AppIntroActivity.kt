...
class AppIntroActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val in1 = loadAnimation(this, android.R.anim.slide_in_left).apply {
                duration = 150
            }
            val out1 = loadAnimation(this, android.R.anim.slide_out_right).apply {
                duration = 150
            }
        ...
        mPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                when (position) {
                    ...
                    3 -> {
                        setTitleText(getString(R.string.theme))
                        rightButton.isEnabled = true
                    ...
                    6 -> {
                        ...
                        leftButton.setOnClickListener { mPager.currentItem = 5 }
                        rightButton.setOnClickListener {
                            val prefs = Prefs(this@AppIntroActivity)
                            prefs.putBoolean(K.PREF.IS_FIRST_START, false)
                            val i = Intent(this@AppIntroActivity, MainActivity::class.java)
                            startActivity(i)
                            finish()
                        }
                        lifecycleScope.launch (workerContext) {
    ...
    private inner class SliderPageAdapter(
        fm: FragmentManager
