...
class AppsManagerActivity : BaseActivity() {
    ...
    private inner class AppsAdapter internal constructor(private val context: Context, private val dataSet: MutableList<App>) : RecyclerView.Adapter<AppsAdapter.ViewHolder>() {

        init {
            dataSet.sortWith(Comparator { one: App, other: App -> one.label.compareTo(other.label) })
        }
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.appPackageName.setSingleLine(true)
